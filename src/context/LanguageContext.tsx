...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "cat.spine": "Cirugía de Columna",
    "categories.cirugia-de-columna": "Cirugía de Columna",
    "categories.reemplazo-de-rodilla": "Prótesis de Rodilla",
    "categories.protesis-de-cadera": "Prótesis de Cadera",
    "categories.protesis-de-hombro": "Prótesis de Hombro",
    "categories.instrumental-quirurgico": "Instrumental Quirúrgico",
    "categories.medicina-deportiva": "Medicina Deportiva",
    ...
    "catalog.pdf_btn": "Descargar Ficha Técnica (PDF)",
  ...
  en: {
    ...
    "cat.spine": "Spine Surgery",
    "categories.cirugia-de-columna": "Spine Surgery",
    "categories.reemplazo-de-rodilla": "Knee Prosthesis",
    "categories.protesis-de-cadera": "Hip Prosthesis",
    "categories.protesis-de-hombro": "Shoulder Prosthesis",
    "categories.instrumental-quirurgico": "Surgical Instruments",
    "categories.medicina-deportiva": "Sports Medicine",
    ...
    "catalog.pdf_toast": "Catalogue PDF download started (demo).",
    "catalog.pdf_btn": "Download Spec Sheet (PDF)",
    "catalog.3d_toast": "3D Viewer coming soon in final release.",
